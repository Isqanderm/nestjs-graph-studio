...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'focus:bg-devtools-hover-bg data-[state=open]:bg-devtools-hover-bg',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'transition-colors focus:bg-devtools-hover-bg focus:text-text-primary',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-2 h-px bg-border opacity-50', className)}
    {...props}
  />
));
